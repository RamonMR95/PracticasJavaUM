package burbujaPruebas;

import java.util.Random;

import burbujaElementos.Burbuja;
import burbujaElementos.BurbujaCreciente;
import burbujaElementos.BurbujaDebil;
import burbujaElementos.BurbujaLimitada;
import burbujaElementos.BurbujaSensible;
import burbujaGeometria.Circulo;
import burbujaGeometria.Punto;
...
public class PruebaBurbujas {
	...
	/**
	 * M�todo que aplica sobre una burbuja las operaciones
	...
	public static void main(String[] args) {
		...
		//Estructura de datos polim�rfica
